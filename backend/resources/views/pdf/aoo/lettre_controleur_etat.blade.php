...
<head>
    <meta charset="UTF-8">
    <title>Convocation Contrôleur d'État</title>
    <style>
        @page {
...
@endphp
    ...
    <div class="main-title-block">
        Le Directeur Régional du Conseil Agricole RABAT-SALE-KENITRA
        <span class="a-separator">A</span>
        Mr le controleur d'Etat<br>
        Auprès de l'Office Nationale du Conseil Agricole
        <div class="recipient-city">Rabat</div>
    </div>
    ...
    <div class="salutation">Monsieur,</div>

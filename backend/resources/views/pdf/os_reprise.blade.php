...
<head>
    <meta charset="UTF-8">
    <title>Ordre de service de Reprise</title>
    <style>
        @page {
...
<body>
    ...
    <table class="table-borderless" style="margin-bottom: 15px;">
        <tr>
            <td style="width: 50%; font-size: 13px;">N° &nbsp;&nbsp;&nbsp;{{ $marche->os_reprise_numero ?? '......../2024/M..' }}</td>
    ...
    <table class="table-borderless mb-4" style="font-size: 13px;">
        <tr>
            ...
            <td style="width: 3%;">:</td>
            <td style="width: 82%; font-weight: bold;">Ordre de service de Reprise de l'execution</td>
        </tr>
        <tr>
    ...
    <div class="content-body" style="font-size: 13px;">
        ...
        J'ai l'honneur de vous demander de reprendre l'exécution du marché: &nbsp;&nbsp;&nbsp;&nbsp;<strong>{{ $marche->num_marche }}</strong> &nbsp;&nbsp;ayant pour objet<br>
        ...
        @endif
        <br><br>
        La reprise de l'éxecution de ce marché prendra effet à compter de la date de la récéption du présent ordre de service,
    </div>
    ...
    <div class="content-body" style="font-size: 13px; line-height: 1.5;">
        ...
        @endif
        <br><br>
        J'accuse, par la presente, la récéption de l'ordre de service de reprise de l'execution du marché sus-cité
    </div>

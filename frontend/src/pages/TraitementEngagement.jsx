  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.10),_transparent_30%),linear-gradient(135deg,_#f8fafc_0%,_#eef6ff_100%)] pb-24">
      ...
      <main className="w-full px-4 sm:px-6 lg:px-8 max-w-[1920px] mx-auto py-8">
        ...
        {/* RÉSUMÉ DU DOSSIER */}
        <div className="bg-gradient-to-r from-blue-50/90 via-indigo-50/50 to-blue-50/70 rounded-2xl p-5 sm:p-6 shadow-sm border border-blue-100 mb-6 space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-blue-200/50">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 bg-white text-slate-700 border border-blue-200/70 rounded-lg text-xs font-semibold shadow-xs">
                Nature : <span className="text-blue-700 font-bold">{formData.forme_engagement || 'Marché'}</span>
              </span>
              <span className="px-3 py-1 bg-white text-emerald-700 border border-emerald-200 rounded-lg text-xs font-semibold shadow-xs">
                Budget : <span className="text-emerald-800 font-bold">{formData.type_budget || 'Investissement'}</span>
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="lg:col-span-2 bg-white rounded-xl p-3.5 border border-blue-100 shadow-xs">
              <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Attributaire & Code Ste</p>
              <div className="flex flex-col">
                <span className="text-sm font-bold text-slate-900 truncate max-w-full" title={formData.fournisseur?.raison_sociale || formData.titulaire}>
            ...
            <div className="bg-white rounded-xl p-3.5 border border-blue-100 shadow-xs">
              <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">N° de Marché / CV</p>
              <p className="text-sm font-bold text-slate-900 font-mono">{formData.num_marche || '-'}</p>
              <p className="text-xs text-slate-500 mt-0.5 truncate">{getLotText(formData.lot)}</p>
            </div>
            <div className="bg-white rounded-xl p-3.5 border border-blue-100 shadow-xs">
              <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">AOO / Consult & Date OA</p>
              <p className="text-sm font-bold text-slate-900 font-mono">{formData.aoo?.num_aoo || formData.num_aoo || '-'}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            <div className="bg-white rounded-xl p-3.5 border border-blue-100 shadow-xs">
              <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Montant de la Dépense (DH)</p>
              <p className="text-lg font-bold text-slate-900 mt-1">{formatMoney(formData.montant)}</p>
            </div>
            <div className="bg-amber-50/70 rounded-xl p-3.5 border border-amber-200/80 shadow-xs">
              <p className="text-[11px] font-semibold text-amber-800 uppercase tracking-wider">Intérêt Moratoire (1%)</p>
            ...
            <div className="bg-blue-600 text-white rounded-xl p-3.5 shadow-sm border border-blue-600">
              <p className="text-[11px] font-semibold text-blue-100 uppercase tracking-wider">Montant Total Engagement</p>
